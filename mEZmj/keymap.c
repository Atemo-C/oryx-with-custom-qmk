...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_2:
    if (record->event.pressed) {
      SEND_STRING(SS_LCTL(SS_LSFT(SS_TAP(X_U))) SS_DELAY(1) SS_TAP(X_2) SS_DELAY(1) SS_TAP(X_8) SS_DELAY(1) SS_TAP(X_3) SS_DELAY(1) SS_TAP(X_SPACE));
    }
    break;
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_LCTL(SS_LSFT(SS_TAP(X_U))) SS_DELAY(1) SS_TAP(X_1) SS_DELAY(1) SS_TAP(X_B) SS_DELAY(1) SS_TAP(X_F) SS_DELAY(1) SS_TAP(X_SPACE));
    }
    break;
    case ST_MACRO_4:
    if (record->event.pressed) {
      SEND_STRING(SS_LCTL(SS_LSFT(SS_TAP(X_U))) SS_DELAY(1) SS_TAP(X_1) SS_DELAY(1) SS_TAP(X_A) SS_DELAY(1) SS_TAP(X_9) SS_DELAY(1) SS_TAP(X_SPACE));
    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) {
      SEND_STRING(SS_LCTL(SS_LSFT(SS_TAP(X_U))) SS_DELAY(1) SS_TAP(X_1) SS_DELAY(1) SS_TAP(X_F) SS_DELAY(1) SS_TAP(X_7) SS_DELAY(1) SS_TAP(X_SPACE));
    }
    break;
